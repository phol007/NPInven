...
```
# Menu ระบบ ขอทำโปรโมชั่น
**GO API แสดงรายการใบขอทำโปรโมชั่นที่ยังไม่ได้รับอนุมัติ top 20 เรียงจากเลขที่เอกสาร**
**Request History**
``` 
Url: http://venus.nopadol.com:9002/
Path : requests?access_token=aaa&keyword= (ค้นหาตาม เลขที่เอกสาร,โปรโมชั่น,sectionmanger,ถ้าเป็นค่าว่างจะโชว์ top 20)
method : get
    response 200 : {
		"status":"success",
		“data”:[
		 {
            "doc_no": "RQ6104-0038",
            "doc_date": "2018-04-20T00:00:00Z",
            "sec_man": "54190/อรรถพงษ์ ปวงย้อยแก้ว",
            "is_con_firm": 0,
            "is_cancel": 0,
            "pm_code": "PM6104-0001",
            "creator_code": "artapongpk",
            "create_date": "2018-04-20T11:10:10.977Z",
            "editor_code": "",
            "edit_date": "1900-01-01T00:00:00Z",
            "is_complete_save": 1,
            "subs": [
                {
                    "item_code": "8510092",
                    "item_name": "ถังบำบัดน้ำเสีย DOS ULTRA (ST-21/GY-800L)",
                    "unit_code": "ใบ",
                    "price": 5370,
                    "from_qty": 1,
                    "to_qty": 99999,
                    ...
                    "promotion_type": "04",
                    "cancel_code": "",
                    "cancel_date": "1900-01-01T00:00:00Z",
                    "date_start": "2018-05-01T00:00:00Z",
                    "date_end": "2018-07-31T00:00:00Z"
                },
                {
                    "item_code": "8100801",
                    "item_name": "(P)ชักโครก Nahm ORBIT NM-2500-S (SVP2500S600N01)  สีขาว(ตัวโชว์ ไม่รับเปลี่ยนคืน)",
                    "unit_code": "ชุด",
                    "price": 4490,
                    "from_qty": 1,
                    "to_qty": 99999,
                ...
                {
                    "item_code": "8855673007779",
                    "item_name": "[P]ชักโครก NAHM NM-2790-LED สีขาว  (แบบหม้อน้ำพลาสติกมีไฟ) **เลิกผลิต ไม่รับเปลี่ยนคืน",
                    "unit_code": "ชุด",
                    "price": 4990,
                    "from_qty": 1,
                    "to_qty": 99999,
                ...
                {
                    "item_code": "8200807",
                    "item_name": "(P)สุขภัณฑ์ Nahm NAAN NM-2861-SD (SVP2860S600N01) ฝา Soft สีขาว(ตัวโชว์ ไม่รับเปลี่ยนคืน)",
                    "unit_code": "ชุด",
                    "price": 12500,
                    "from_qty": 1,
                    "to_qty": 99999,
                ...
                {
                    "item_code": "8200805",
                    "item_name": "(P)ชักโครก NAHM NICE NM-1810WT สีขาว (ราคาตัวโชว์ลดล้างสต๊อค ไม่รับเปลี่ยนคืน)",
                    "unit_code": "ชุด",
                    "price": 14500,
                    "from_qty": 1,
                    "to_qty": 99999,
                ...
                {
                    "item_code": "8200750",
                    "item_name": "(P)ชักโครก Nahm Nur  NM-2730 -730D WT (ตัวโชว์ ไม่รับเปลี่ยนคืน)",
                    "unit_code": "ชุด",
                    "price": 13800,
                    "from_qty": 1,
                    "to_qty": 99999,
                ...
                {
                    "item_code": "8101101",
                    "item_name": "(P)ชักโครก Nahm Nuvo NM-2320-S WT สีขาว **เลิกผลิต** (ตัวโชว์ ไม่รับเปลี่ยนคืน)",
                    "unit_code": "ชุด",
                    "price": 6675,
                    "from_qty": 1,
                    "to_qty": 99999,
                ...
                {
                    "item_code": "8200756",
                    "item_name": "ชักโครก NAHM SLIM ECO NM-2007WT(SVP2000S401N01) 3/4.5 ลิตร สีขาว",
                    "unit_code": "ชุด",
                    "price": 4330,
                    "from_qty": 1,
                    "to_qty": 99999,
